 ...
 */
@Description("An operator swapping one or more pairs in two multi-dimensional parameter, adapted from SwapOperator to accept boolean parameters as input.")
public class MultiSwapOperator extends Operator {
    ...
    final public Input<BooleanParameter> boolparameterInput = new Input<>("boolparameter", "a boolean parameter to swap individual values for");
    ...
    public void initAndValidate() {
        ...
        if (boolparameterInput.get() != null) {
            booleanParameter = boolparameterInput.get();
        }
    ...
    public double proposal() {
        ...
        for (int i = 0; i < howMany; i++) {
            ...
            booleanParameter.swap(left, right);
        }
