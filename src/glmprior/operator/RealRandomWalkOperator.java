...
/**
 * Extended from MASCOT package by Nicola Muller
 */
...
public class RealRandomWalkOperator extends Operator {
    ...
    final public Input<Boolean> scaleOnlyOneInput =
            new Input<>("scaleOnlyOne", "if true, only one element of the parameter is scaled", false);
    ...
    public void initAndValidate() {
        ...
        scaleOnlyOne = scaleOnlyOneInput.get();
    }
    ...
    public double proposal() {
        ...
        if(indicatorInput.get() != null & scaleOnlyOne) {
            final int i;
            i = Randomizer.nextInt(param.getDimension());
